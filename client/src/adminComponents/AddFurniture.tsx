...
type Props = {
	saveFurniture: (e: React.FormEvent, formData: furnitureSchema) => void
}

const AddFurniture: React.FC<Props> = ({ saveFurniture }) => {
	...
	return (
		<div>
			...
			<Button disabled={formData === undefined ? true : false} onClick={(e) => saveFurniture(e, formData)}>Add</Button>
		</div>
	)
}
